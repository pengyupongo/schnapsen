...
class Bot5(Bot):
    ...
    Rule 5: If follower and can win, win with the cheapest winning card (lowest card points).
    ...
    def get_move(self, perspective: PlayerPerspective, leader_move: Optional[Move]) -> Move:
        ...
        # ---------------- Rules 4–5: follower win, and win cheaply ----------------
        if leader_move is not None:
            ...
            # Rule 4: restrict to winners
            if winning_moves:
                # Rule 5: from winners, keep only the cheapest winners
